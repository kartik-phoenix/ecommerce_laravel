    ...
    */
    ...
    'github' => [
     ...
     'google' => [
        ...
        'client_id' =>  env('GOOGLE_CLIENT_ID'), //'122886334250-fsfd8ugugkr0hjrkakukbgnnruomjn95.apps.googleusercontent.com', //Google API
        'client_secret' =>  env('GOOGLE_CLIENT_SECRET'), //'eyuwbzXGBgbebzPXNiqSOods', //Google Secret
